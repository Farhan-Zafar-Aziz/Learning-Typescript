/* Q4 Famous Quote: Find a quote from a famous person you admire. Print the quote
 ...
 console.log(`${famous_person} once said, "${'Failure is not fatal until we surrender, trying again is the key of glorious victory.'}" `);
...
let famous_quote = "Failure is not fatal until we will surrender, trying again is the key of glorious victory.";
console.log(`${famousPerson} once said, "${famous_quote}"`);
